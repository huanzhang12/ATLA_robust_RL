...
PARAMS = {
    "game": ["Walker2d-v2"],
    "mode": ["adv_ppo"],
    "out_dir": ["attack_atla_lstm_sappo_walker/agents"],
    ...
    "adv_val_lr": [1e-2, 3e-2, 0.1],
    "save_iters": [20],
    "train_steps": [488],
    "robust_ppo_eps": [0.05], # used for attack
    "history_length": [100],
    "load_model": ["models/atla_release/ATLA-LSTM-PPO/model-atla-lstm-sappo-walker.model"], # models for attack
    "value_clipping": [True],
}

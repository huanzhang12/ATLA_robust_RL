...
PARAMS = {
    "game": ["HalfCheetah-v2"],
    "mode": ["adv_ppo"],
    "out_dir": ["attack_lstm_halfcheetah/agents"],
    ...
    "adv_val_lr": [3e-4, 1e-3, 3e-3],
    "save_iters": [20],
    "train_steps": [488],
    "robust_ppo_eps": [0.15],  # used for attack
    "history_length": [100],
    "load_model": ["models/atla_release/LSTM-PPO/model-lstm-ppo-halfcheetah.model"],  # models for attack
    "value_clipping": [True],
}

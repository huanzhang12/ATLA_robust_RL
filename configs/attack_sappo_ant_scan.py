...
PARAMS = {
    "game": ["Ant-v2"],
    "mode": ["adv_ppo"],
    "out_dir": ["attack_sappo_convex_ant/agents"],
    ...
    "adv_ppo_lr_adam": [1e-5, 3e-5, 1e-4],
    "adv_val_lr": [1e-5, 3e-5, 1e-4],
    "save_iters": [100],
    "train_steps": [2441],
    "robust_ppo_eps": [0.15],  # used for attack
    "load_model": ["models/atla_release/SAPPO/model-sappo-convex-ant.model"],  # models for attack
    "value_clipping": [True],
}
